...
public class streamplayer4Allx extends AppCompatActivity implements  YAVPApp.ICrashListener, GesturePlayerControlView.Listener  {
...
*/
    ...
    private HashMap<String, Integer> getHashmap(String key) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(streamplayer4Allx.this);
        Gson gson = new Gson();
    ...
    private void initializePlayer() {
        DefaultHttpDataSourceFactory httpDataSourceFactory = new DefaultHttpDataSourceFactory(Util.getUserAgent(streamplayer4Allx.this, getPackageName()), null,
        ...
        DefaultTrackSelector trackSelector = new DefaultTrackSelector(streamplayer4Allx.this);
        ...
        SingleSampleMediaSource.Factory subtitleSource = new SingleSampleMediaSource.Factory(ddsf);

        MediaSourceFactory mediaSourceFactory = new DefaultMediaSourceFactory(ddsf)
        ...
        pip5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(streamplayer4Allx.this)
     ...
     //   exoPlayer.setMediaItem(mediaItem);
        ...
        MediaSource mediaSource = x(uri,ddsf);
