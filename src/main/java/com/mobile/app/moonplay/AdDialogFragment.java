    ...
    //    View view = requireActivity().getLayoutInflater().inflate(R.layout.dialog_ad, null);
      //  builder.setView(view);
        ...
        if (rewardAmount > 0 && rewardType != null) {
           // builder.setTitle(getString(R.string.sel, rewardAmount, rewardType));
        }

       // builder.setNegativeButton("", new DialogInterface.OnClickListener() {@Override public void onClick(DialogInterface dialog, int id) { getDialog().cancel(); }});
      ...
      //  final TextView textView = dialogView.findViewById(R.id.timer);
        countDownTimer =
                new CountDownTimer(time * 1000, 50) {
                   ...
                   //     textView.setText(String.format("Starting", timeRemaining));
                    }
