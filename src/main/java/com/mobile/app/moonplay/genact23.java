...
public class genact23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query = medieval.whereEqualTo("type","prime").limit(55);

        zas=findViewById(R.id.zas);

        xcx=findViewById(R.id.prozzz);

        aps=new MyItemAdapterxxgrid(genact23.this);
        ...
        GridLayoutManager glm = new GridLayoutManager(genact23.this, 2);
                       ...
                       // movie.setUploader(medieval.getId());
                        ...
                        button3.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                query = medieval.whereEqualTo("type","prime").startAfter(doc).limit(18);
                                loadata();
                            }
                        });
