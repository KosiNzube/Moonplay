...
import com.mobile.app.moonplay.BuildConfig;
        ...
        PreferenceFragmentCompat.OnPreferenceStartFragmentCallback
{
    ...
    public static class PreferencesAboutFragment extends PreferenceFragmentCompat
    {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey)
        {
            ...
            if (versionPref != null)
                versionPref.setSummary(String.format(getString(R.string.settings_about_version_f), BuildConfig.VERSION_NAME, BuildConfig.VERSION_CODE, BuildConfig.BUILD_TYPE));
        }
    }
}
