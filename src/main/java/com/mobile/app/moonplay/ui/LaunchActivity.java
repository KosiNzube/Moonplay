package com.mobile.app.moonplay.ui;

import androidx.annotation.NonNull;
import androidx.appcompat.app.AppCompatActivity;
import androidx.preference.PreferenceManager;
import com.mobile.app.moonplay.R;
import com.mobile.app.moonplay.ui.mediapicker.MediaPickerActivity;
...
public class LaunchActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        link = intent.getExtras().getString("video");
    ...
    private boolean launchPlayback(Intent callingIntent)
    {
        ...
        launchIntent.putExtra("genre",genre);
        launchIntent.putExtra("video",link);
        if (image.startsWith("http")) {
            launchIntent.putExtra("photo", image);
        }
