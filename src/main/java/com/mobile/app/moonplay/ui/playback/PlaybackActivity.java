...
import com.mobile.app.moonplay.Streampostion;
...
public class PlaybackActivity extends AppCompatActivity implements YAVPApp.ICrashListener, GesturePlayerControlView.Listener  {
    ...
    ImageView backkk,img,kanim,pip,thumb;
    //endregion
...
*/
        ...
        anime4kQSButton.setVisibility(View.INVISIBLE);
        //  kanim.setVisibility(View.INVISIBLE);
        ...
        title = callIntent.getStringExtra(Intent.EXTRA_TITLE);
        ...
        linkk = callIntent.getExtras().getString("video");
        image=callIntent.getExtras().getString("photo");
        genre=callIntent.getExtras().getString("genre");
        if (image.startsWith("http")) {
            Picasso.get().load(image).fit().centerCrop().into(img);
        }
        ...
        if (!title.isEmpty()) {
            ...
            if (playbackService != null) {
                editor.putInt("uioii", (int) playbackService.getPlaybackPosition());
            }
            editor.putString("images", image);
            editor.putString("streamLink", String.valueOf(playbackUri));
            editor.putString("names",title);
        ...
        if (anime4KFilter == null)
        {
            ...
            anime4KFilter = new GLAnime4K(PlaybackActivity.this, R.raw.common, R.raw.colorget, R.raw.colorpush, R.raw.gradget, R.raw.gradpush);
            ...
            int fpsLimit = -1;
            if (ConfigUtil.getConfigBoolean(PlaybackActivity.this, ConfigKeys.KEY_ANIME4K_FPS_LIMIT_ENABLE, R.bool.DEF_ANIME4K_FPS_LIMIT_EN))
            {
                //enable the fps limit
                fpsLimit = ConfigUtil.getConfigInt(PlaybackActivity.this, ConfigKeys.KEY_ANIME4K_FPS_LIMIT, R.integer.DEF_ANIME4K_FPS_LIMIT);
            }
    ...
    private void initzee() {
        ...
        pip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ConfigUtil.getConfigBoolean(PlaybackActivity.this, ConfigKeys.KEY_ENTER_PIP_ON_LEAVE, R.bool.DEF_ENTER_PIP_ON_LEAVE) && playbackService.getIsPlaying())
                    tryGoPip();
            }
        });
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Glide.with(PlaybackActivity.this).asGif()
                        .load(R.raw.tv)
                        .diskCacheStrategy(DiskCacheStrategy.DATA).centerCrop().into(img);


                img.setAlpha((int) 0.3);
    ...
    public void onBackPressed() {
        ...
        if (playbackService!=null) {
            if (!title.isEmpty()) {
                ...
                if (playbackService != null) {
                    editor.putInt("uioii", (int) playbackService.getPlaybackPosition());
                    ppos= (int) playbackService.getPlaybackPosition();
                }
                editor.putString("images", image);
                pimage=image;
                editor.putString("streamLink", String.valueOf(playbackUri));

                plink=String.valueOf(playbackUri);
            ...
            xx.add(0, new Streampostion(image, (int) playbackService.getPlaybackPosition(), title, linkk, genre,""));
            save(xx);
