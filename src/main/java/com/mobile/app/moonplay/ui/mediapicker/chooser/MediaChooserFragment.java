package com.mobile.app.moonplay.ui.mediapicker.chooser;
...
import com.mobile.app.moonplay.ui.LaunchActivity;
...
/**
 * Fragment that shows {@link} for each media element on the device that matches the MediaKind given.
 * You should get {@link Manifest.permission#READ_EXTERNAL_STORAGE} before you use this songsfragment. If not, a "request permissions" button will be shown.
 */
public class MediaChooserFragment extends Fragment implements RecyclerMediaEntryAdapter.CardClickListener
{
     ...
     * Request {@link Manifest.permission#READ_EXTERNAL_STORAGE} permissions and reload media in the songsfragment if the permissions were granted.
     */
    ...
    /**
     * Type of media this chooser songsfragment shows
     */
    private MediaEntry.MediaKind mediaKind = MediaEntry.MediaKind.VIDEO;

    /**
     * a list of all media on this device that matches the {@link #mediaKind} of this songsfragment
     */
    private List<MediaEntry> mediaEntries = new ArrayList<>();
    //endregion

    /**
     * Create a default config songsfragment with mediaKind = VIDEO
     * <p>
     * This may cause a bug where a music songsfragment is converted to video IF the songsfragment is recreated using this constructor.
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        //initialize media for this songsfragment
    ...
    /**
     * Use the {@link MediaStore} to get all media matching the {@link #mediaKind} of this songsfragment
     */
