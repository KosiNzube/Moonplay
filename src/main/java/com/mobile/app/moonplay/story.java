  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    buttonOne.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Intent intent=new Intent(story.this,uxx.class);
    ...
    try{
      ...
      collectionReference.orderBy("timestamp", Query.Direction.ASCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
        ...
        public void onComplete(@NonNull Task<QuerySnapshot> task) {
          if (task.isSuccessful()) {
            ...
            if (movieArray.size() > 0) {
              ...
              RecyclerView view1=findViewById(R.id.fifi);
               adapter = new laysq(story.this, movieArray, new laysq.xx() {
                @Override
              ...
              GridLayoutManager glm = new GridLayoutManager(story.this, 2);
          ...
          if (!task.isSuccessful()) {
            Toast.makeText(story.this, "Could not connect", Toast.LENGTH_SHORT).show();
          }
        }
      });
