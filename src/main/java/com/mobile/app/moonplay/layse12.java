...
public class layse12 extends RecyclerView.Adapter<layse12.MyViewHolder> {
    ...
    public layse12(Context context, List<doc> itemDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.layse,viewGroup,false);
