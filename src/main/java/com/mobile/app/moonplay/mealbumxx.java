...
public class mealbumxx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView z=findViewById(R.id.backx);
        ...
        textView.setText("Explore albums");
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (int i = size - 1; i >= 0; i--) {
                                ...
                                if (movie.getRec()!=null) {
                                    if (!movie.getRec().contains("rec")) {
                                        if (movie.getLikes() > 5) {
                                ...
                                if (movieArray.size() > 0) {
                                    ...
                                    GridLayoutManager glm = new GridLayoutManager(mealbumxx.this, 2);
                                    view1.setLayoutManager(glm);
                                    layse12xx adapter3 = new layse12xx(mealbumxx.this, movieArray);
