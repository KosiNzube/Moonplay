...
public class storyme extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    buttonOne.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Intent intent=new Intent(storyme.this,uxxq.class);
    ...
    try{
      ...
      collectionReference=db.collection("instvid");
        ...
        public void onComplete(@NonNull Task<QuerySnapshot> task) {
          if (task.isSuccessful()) {
            ...
            for (int i = size - 1; i >= 0; i--) {
              ...
              if (movie.getId().equals(user.getUid())) {
            ...
            if (movieArray.size() > 0) {
              ...
              RecyclerView view1=findViewById(R.id.fifi);
               adapter = new laysq(storyme.this, movieArray, new laysq.xx() {
                @Override
              ...
              GridLayoutManager glm = new GridLayoutManager(storyme.this, 2);
          ...
          if (!task.isSuccessful()) {
            Toast.makeText(storyme.this, "Could not connect", Toast.LENGTH_SHORT).show();
          }
        }
      });
