...
public class kxmusic extends AppCompatActivity {
  ImageView imageView;
  TextView back,play;
  RecyclerView recyclerView;
  TextView nodown;
  ViewPager viewPager;
  PageViewAdapteryx pageViewAdapter;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.kxmusic);

    viewPager=findViewById(R.id.viewp);

    popular=findViewById(R.id.popular);
    genre=findViewById(R.id.genre);
    pageViewAdapter=new PageViewAdapteryx(getSupportFragmentManager());
