...
public class laysq3 extends RecyclerView.Adapter<laysq3.MyViewHolder> {
    ...
    public laysq3(Context context, List<instV> itemDataList) {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, singlesplayx.class);
