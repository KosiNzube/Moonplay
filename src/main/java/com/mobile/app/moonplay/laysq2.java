...
public class laysq2 extends RecyclerView.Adapter<laysq2.MyViewHolder> {
    ...
    public laysq2(Context context, List<instV> itemDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.laysq2,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
      ...
      //  myViewHolder.maindes.setText(itemDataList.get(i).getDescription());
        ...
        if (itemDataList.get(i).getDes()!=null) {
            if (itemDataList.get(i).getDes().length() > 35) {
                myViewHolder.maingenre.setText(itemDataList.get(i).getDes().substring(0, 35) + "...");
            } else {
                myViewHolder.maingenre.setText(itemDataList.get(i).getDes());
            }

            if (itemDataList.get(i).getPoster().length() > 35) {
                myViewHolder.maindes.setText(itemDataList.get(i).getPoster().substring(0, 35) + "...");
            } else {
