...
public class formeded extends RecyclerView.Adapter<formeded.MyViewHolder> {
    ...
    public formeded(Context context, List<Movie> itemDataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, @SuppressLint("RecyclerView") final int i) {
        ...
        myViewHolder.pasu.setVisibility(View.GONE);
...
*/
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            pasu=itemView.findViewById(R.id.pausecardy);
