...
public class layst extends RecyclerView.Adapter<layst.MyViewHolder> {
    ...
    public layst(Context context, List<doc> itemDataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
     ...
     //   myViewHolder.maingenre.setText(itemDataList.get(i).getDescription());
        ...
        if(itemDataList.get(i).getDescription()!=null) {
            if (itemDataList.get(i).getDescription().length() > 30) {
                myViewHolder.maingenre.setText(itemDataList.get(i).getDescription().substring(0, 30) + "...");
            } else {
                myViewHolder.maingenre.setText(itemDataList.get(i).getDescription());
            }
