...
public class atchadapter extends RecyclerView.Adapter<atchadapter.MyViewHolder>{
    private Context context;
    private List<shorts> itemDataList;

    public atchadapter(Context context, List<shorts> itemDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.hortitem,parent,false);
