...
public class singlesplay extends AppCompatActivity  {
    ...
    private void initView() {
        ...
        //movieArray.addAll(curate.movieArray);
        ...
        if (movieArray.size() > 0) {
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(singlesplay.this);
