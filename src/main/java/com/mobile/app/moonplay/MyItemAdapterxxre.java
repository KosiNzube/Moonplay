...
public class MyItemAdapterxxre extends RecyclerView.Adapter<MyItemAdapterxxre.MyViewHolder> {
    ...
    public MyItemAdapterxxre(Context context, List<Movie> itemDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.layout_itemxx,viewGroup,false);
