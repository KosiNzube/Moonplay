...
public class genact9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query = medieval.orderBy("timestamp").limit(55);
        ...
        aps=new recoplaylist(genact9.this);
        ...
        GridLayoutManager glm = new GridLayoutManager(genact9.this, 2);
