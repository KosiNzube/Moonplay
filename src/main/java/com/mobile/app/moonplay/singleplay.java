...
public class singleplay extends RecyclerView.Adapter<singleplay.MyViewHolder>{
    private Context context;
    private List<single> itemDataList;

    public singleplay(Context context, List<single> itemDataList) {
       ...
       Picasso.get().load(itemDataList.get(i).getImage()).into(holder.img_item);
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context,singleplayer.class);
