...
public class newest extends RecyclerView.Adapter<newest.MyViewHolder>{
    private Context context;
    private List<shorts> itemDataList;

    public newest(Context context, List<shorts> itemDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.rexo,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int i) {
       ...
       Picasso.get().load(itemDataList.get(i).getImage()).centerCrop().fit().into(holder.img_item);
        holder.genre.setText(itemDataList.get(i).getGenre());
        holder.desc.setText(itemDataList.get(i).getDescription());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView txt_item_title,genre,desc;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            desc=itemView.findViewById(R.id.typee);
