...
public class genreplaylist extends RecyclerView.Adapter<genreplaylist.MyViewHolder> {

    private String subx;
    private Context context;
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private CollectionReference ge=db.collection("Spanish");
    private List<Movie> itemDataList=new ArrayList<>();
    private final static int FADE_DURATION = 590;
    private SharedPreferences appPreferences;
    public genreplaylist(Context context) {
       ...
       // setFadeAnimation(myViewHolder.img_item);
        ...
        myViewHolder.card.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                ge.document(itemDataList.get(i).getId()).update("tag", itemDataList.get(i).getUploader()).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
