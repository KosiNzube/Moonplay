...
public class layse extends RecyclerView.Adapter<layse.MyViewHolder> {
    ...
    public layse(Context context, List<doc> itemDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.layse12,viewGroup,false);
