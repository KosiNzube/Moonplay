...
public class offthewall extends Fragment  {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), genact2quick.class);
        ...
        memex.orderBy("timestamp", Query.Direction.ASCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                if (e!=null){
                    ...
                    for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {
                        quick gigi = doc.toObject(quick.class);

                        if (gigi.getGenre()!=null) {
                    ...
                    if (movies.size() > 0) {
                        ...
                        populary adapter = new populary(getActivity(), movies);
