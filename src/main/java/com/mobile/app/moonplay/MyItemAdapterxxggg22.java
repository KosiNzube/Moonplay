...
public class MyItemAdapterxxggg22 extends RecyclerView.Adapter<MyItemAdapterxxggg22.MyViewHolder> {
    ...
    public MyItemAdapterxxggg22(Context context, List<Movie> itemDataList) {
        ...
        myViewHolder.card.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                if (isNetworkAvailable()) {
                    Main7Activity.db.collection("subusers").document(Main7Activity.user.getUid()).collection("watchl").document(itemDataList.get(i).getId()).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
