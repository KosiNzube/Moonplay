...
public class MyItemAdapterzz extends RecyclerView.Adapter<MyItemAdapterzz.MyViewHolder> {
    ...
    public MyItemAdapterzz(Context context, List<Movie> itemDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.layout_itemz,viewGroup,false);
