...
public class popo extends AppCompatActivity implements  YAVPApp.ICrashListener, GesturePlayerControlView.Listener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xi=intent.getExtras().getInt("pos");
    ...
    public void playback_OnClick(View view)
    {
        switch (view.getId())
        {
            ...
            case R.id.pb_screen_rotation_auto:
            {
                ...
                Toast.makeText(getApplicationContext(),"xoxo",Toast.LENGTH_SHORT).show();
...
*/
    ...
    private HashMap<String, Integer> getHashmap(String key) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(popo.this);
        Gson gson = new Gson();
    ...
    public void onBackPressed() {
        ...
        yoyoo= (int) exoPlayer.getCurrentPosition();
        streamplayer4All.ppos= (int) exoPlayer.getCurrentPosition();
        streamplayer4All.pimage=image;
        streamplayer4All.plink=linkk;
        streamplayer4All.pname=name;
        streamplayer4All.pgenre=genre;
        streamplayer4All.psub=subtitleUri;
    ...
    private void initializePlayer() {
        DefaultHttpDataSourceFactory httpDataSourceFactory = new DefaultHttpDataSourceFactory(Util.getUserAgent(popo.this, getPackageName()), null,
        ...
        DefaultDataSourceFactory ddsf = new DefaultDataSourceFactory(this, httpDataSourceFactory);
        ...
        DefaultTrackSelector trackSelector = new DefaultTrackSelector(popo.this);
        ...
        pip5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(popo.this)
