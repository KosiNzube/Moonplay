...
public class mealbumxxx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.makemusicxxx2);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (DocumentSnapshot documentSnapshot : Objects.requireNonNull(task.getResult())) {
                                ...
                                if (x.contains(documentSnapshot.getId())) {
                            ...
                            for (int i = size - 1; i >= 0; i--) {
                                ...
                                if (movieArray.size() > 0) {
                                    ...
                                    GridLayoutManager glm = new GridLayoutManager(mealbumxxx.this, 2);
                                    view1.setLayoutManager(glm);
                                    layse12xx adapter3 = new layse12xx(mealbumxxx.this, movieArray);
