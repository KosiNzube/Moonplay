...
public class xxx extends Fragment  {
        ...
        listener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user!=null){
                    ...
                    //   Toast.makeText(splash.this,"You already logged in"+user.getUid(),Toast.LENGTH_SHORT).show();
                    ...
                    startActivityForResult(AuthUI.getInstance().createSignInIntentBuilder().setAvailableProviders(providers).setLogo(R.mipmap.s).setTheme(R.style.hihiggia).build(),AUTH_REQUEST_CODE);
                }
    ...
    private void jiji() {
        ...
        LinearLayout ev=getActivity().findViewById(R.id.everything);


        ev.setVisibility(View.VISIBLE);
        textView=getActivity().findViewById(R.id.button3);
