...
public class singlesplayxy extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver((broadcastReceiver), new IntentFilter("com.example.exoplayer.PLAYER_STATUS"));
        ...
        video=o.getExtras().getInt("image");
    ...
    private void initView() {
        ...
        movieArray.addAll(mevideo.movieArrayxxxy);
        ...
        if (movieArray.size() > 0) {
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(singlesplayxy.this);
            ...
            mRecyclerView.smoothScrollToPosition(video+1);
            layoutManager.scrollToPositionWithOffset(video+1,20);
