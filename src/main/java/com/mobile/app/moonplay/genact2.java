...
public class genact2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qqqq.setVisibility(View.VISIBLE);
        ...
        query = medieval.whereEqualTo("tag",cast).limit(50);
        zas=findViewById(R.id.zas);


        qqqq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(genact2.this, genact2latest.class);
                intent.putExtra("search",cast);
        ...
        aps=new MyItemAdapterxxgrid(genact2.this);
        ...
        GridLayoutManager glm = new GridLayoutManager(genact2.this, 2);
                       ...
                       // movie.setUploader(medieval.getId());
                        ...
                        button3.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                query =  medieval.whereEqualTo("tag",cast).startAfter(doc).limit(18);
                                loadata();
                            }
                        });
