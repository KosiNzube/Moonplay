...
public class singlesplayx extends AppCompatActivity  {
    ...
    private void initView() {
        ...
        movieArray.addAll(homecurat.movieArrayxxx);
        ...
        if (movieArray.size() > 0) {
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(singlesplayx.this);
