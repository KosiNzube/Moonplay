...
public class dididi extends Fragment  {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        query = memex.orderBy("timestamp", Query.Direction.ASCENDING).limit(10);

        xcx=view.findViewById(R.id.progressBarzaza);
        aps=new popularymoo(getActivity());
         view1=view.findViewById(R.id.first);

        recyclerView = view.findViewById(R.id.yiyii);
        ...
        button3=view.findViewById(R.id.xxxx);


        scrollView=view.findViewById(R.id.scroll);
        thriller=view.findViewById(R.id.mus);

        thriller.setText("Recommended ");
                ...
                if (task.isSuccessful()) {
                    ...
                    for (int i = size - 1; i >= 0; i--) {
                        ...
                        if (!movieArray.contains(movie))
                            if (!movie.getGenre().toLowerCase().contains("prime")) {
                    ...
                    if (movieArray.size() > 0) {
                        ...
                        first adapter = new first(getActivity(), movies);
    ...
    private void loadata() {
        ...
        query.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ArrayList<quick> movies = new ArrayList<>();
                    for (DocumentSnapshot documentSnapshot : Objects.requireNonNull(task.getResult())) {
                        quick gigi = documentSnapshot.toObject(quick.class);

                        if (!gigi.getGenre().toLowerCase().contains("prime")) {
                            movies.add(gigi);
                        }
                        ...
                        button3.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                query = memex.orderBy("timestamp", Query.Direction.ASCENDING).startAfter(documentSnapshot).limit(10);
                                loadata();
                            }
                        });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        return inflater.inflate(R.layout.offthewall, container, false);
