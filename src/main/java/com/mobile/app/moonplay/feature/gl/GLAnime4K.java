package com.mobile.app.moonplay.feature.gl;
...
public class GLAnime4K extends GLFilterBase implements VideoListener
{
    ...
    //all shaders share the same vertex shader (only doing stuff in songsfragment shaders)
    ...
    /**
     * Read a songsfragment shader source from res/raw
     *
