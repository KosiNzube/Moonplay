...
public class VideoPlaybackService extends Service
{
    ...
    public void loadMedia(@NonNull Uri mediaUri, boolean playWhenReady, long startPosition)
    {
        ...
        player.prepare(mediaFactory.createMediaSource(mediaUri),false,false);
       // player.setMediaSource(mediaFactory.createMediaSource(mediaUri),true);
    ...
    private void initializePlayer()
    {
        ...
        player = new SimpleExoPlayer.Builder(this,renderersFac, ExtractorsFactory.EMPTY).setLoadControl(loadControl).build();
        //register listeners
     ...
     */
    @TargetApi(Build.VERSION_CODES.M)
    private void hasInternetPermission()
    {
