...
public class iceAdapterX extends RecyclerView.Adapter<iceAdapterX.IceHolder> {

  private Context context;
  private List<icemodel> itemDataList;

  public iceAdapterX(Context context, List<icemodel> itemDataList) {
  ...
  public void onBindViewHolder(@NonNull IceHolder holder, final int i) {
    ...
    SharedPreferences preferences33 = PreferenceManager.getDefaultSharedPreferences(context);
