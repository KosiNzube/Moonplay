...
public class newadapter extends RecyclerView.Adapter<newadapter.MyViewHolder>{
    ...
    public newadapter(Context context, List<Movie> itemDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.cinema,parent,false);
    ...
    //    setFadeAnimation(holder.img_item);
        ...
        holder.mFadingEdgeLayout.setFadeSizes(300, 200, 200, 200);
